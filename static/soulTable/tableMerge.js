...
layui.define(["table"], function (e) {
    ...
    e("tableMerge", {
        render: function (n) {
            ...
            function d(e, a) {
                for (var r = c[a].mergeField, i = layui.table.cache[n.id].length, t = 0; t < r.length; t++) if (layui.table.cache[n.id][i - 2 - e][r[t]] !== layui.table.cache[n.id][i - 1 - e][r[t]]) return 1
            }

            layui.each(n.cols, function (i, e) {
                layui.each(e, function (e, a) {
                    if (a.merge && a.field) {
                        var r = [a.field];
                        !0 !== a.merge && (r = "string" == typeof a.merge ? [a.merge] : a.merge), c[n.index + "-" + i + "-" + e] = {
                            mergeField: r,
                            rowspan: 1
                        }
                    }
                ...
                for (var a in c) if (e === t.length - 1 || d(e, a)) {
                    var r = o(this).children('[data-key="' + a + '"]').outerHeight(), i = 0;
                    0 === t.eq(e).data("index") && (i = 1), o(this).children('[data-key="' + a + '"]').attr("rowspan", c[a].rowspan).css({
                        position: "static",
                ...
                } else o(this).children('[data-key="' + a + '"]').remove(), l.eq(e).children('[data-key="' + a + '"]').remove(), h.eq(e).children('[data-key="' + a + '"]').remove(), c[a].rowspan += 1
            })
        }
    })
});